...
public class EternalTrait extends TraitContainer implements IActiveTrait {

    public EternalTrait(String name, Formatting formatting) {
    ...
    public void activeInventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        if(!world.isClient && selected) {
            ...
            if (14 == world.getRandom().nextInt(50)) {
