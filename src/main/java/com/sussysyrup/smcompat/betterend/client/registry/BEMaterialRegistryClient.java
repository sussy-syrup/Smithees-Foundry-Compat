...
public class BEMaterialRegistryClient {
    ...
    {
        ApiMaterialRegistry.getInstance().registerColours("eternalcrystal",
                new Color(53, 57, 152),
                new Color(50, 90, 100),
        ...
        //Diamond 2.0
        ApiMaterialRegistry.getInstance().registerColours("terminite",
                new Color(1, 76, 71),
                new Color(1, 98, 91),
                new Color(1, 133,123),
                new Color(0, 168, 148),
        ...
        //Diamond 1.5
        ApiMaterialRegistry.getInstance().registerColours("thallasium",
                new Color(32, 73, 94),
        ...
        ApiMaterialRegistry.getInstance().registerColours("aeternium",
                new Color(12, 16, 16),
                new Color(17, 46, 42),
                new Color(63, 82,81),
